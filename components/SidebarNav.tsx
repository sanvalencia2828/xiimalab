  ...
  return (
    ...
    `}>
        ...
        <div className="p-4 border-t border-white/[0.06]">
          ...
          {/* Wallet pill */}
          <Link href="/settings">
            <div className={`mt-3 flex items-center gap-2.5 px-2 py-2 card-premium transition-colors cursor-pointer ${isConnected ? "hover:bg-emerald-500/5" : "hover:bg-amber-500/5"
              }`}>
              <div className={`w-7 h-7 rounded-full flex items-center justify-center ${isConnected
